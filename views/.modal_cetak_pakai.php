<div id="cetakpdfpakai" class="modal fade" role="dialog">
          		<div class="modal-dialog">
          			<div class="modal-content">
          				<div class="modal-header">
          					<button type="button" class="close" data-dismiss="modal">&times;</button>
          					<h4 class="modal-title">Cetak PDF data pemakaian barang</h4>
          				</div>
          					...
          					<div class="modal-footer">
          						<a href="./report/cetak_pakai_barang.php" target="_blank" class="btn btn-primary btn-sm">Cetak semua data</a>
          					</div>
